...
(() => {
  ...
  exports.modules = {
    /***/ 8608: /***/ (
      ...
      const core_namespaceObject = require('@keystone-6/core'); // CONCATENATED MODULE: external "@keystone-6/core/fields"
      const fields_namespaceObject = require('@keystone-6/core/fields'); // CONCATENATED MODULE: external "@keystone-6/fields-document"
      const fields_document_namespaceObject = require('@keystone-6/fields-document'); // CONCATENATED MODULE: ../../schema.ts
      /*
...
*/ // Like the `config` function we use in keystone.ts, we use functions
      ...
      const auth_namespaceObject = require('@keystone-6/auth'); // CONCATENATED MODULE: external "@keystone-6/core/session"
      const session_namespaceObject = require('@keystone-6/core/session'); // CONCATENATED MODULE: ../../auth.ts
      /*
...
*/
      ...
      /* harmony default export */ const keystone = withAuth(
        ...
        (0, core_namespaceObject.config)({
          ...
          ui: {
            ...
            isAccessAllowed: (context) => {
              var ref;
              return !!((ref = context.session) === null || ref === void 0
                ? void 0
                : ref.data);
            },
          },
  ...
  var __webpack_exports__ = __webpack_exec__(8608);
