...
exports.modules = {
  ...
  /***/ 1170: /***/ (module, __unused_webpack_exports, __webpack_require__) => {
  ...
  /***/ 4615: /***/ (module, __unused_webpack_exports, __webpack_require__) => {
    'use strict';

    if (true) {
      module.exports = __webpack_require__(8250);
    } else {
    }
  ...
  /***/ 8250: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    'use strict';
    ...
    var CellContainer = __webpack_require__(5250);
    var CellLink = __webpack_require__(5064);
    ...
    const Field = () => null;
    const Cell = (_ref) => {
      let { item, field, linkTo } = _ref;
      let value = item[field.path] + '';
      return linkTo
        ? core.jsx(CellLink.CellLink, linkTo, value)
        : core.jsx(CellContainer.CellContainer, null, value);
    };
    Cell.supportsLinkTo = true;
    const CardValue = (_ref2) => {
      let { item, field } = _ref2;
      return core.jsx(
        fields.FieldContainer,
        null,
        core.jsx(fields.FieldLabel, null, field.label),
        item[field.path]
      );
    };
  ...
  /***/ 904: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    'use strict';
    ...
    var _objectSpread = __webpack_require__(8043);
    var hashString = __webpack_require__(4380);
    var core = __webpack_require__(5006);
    __webpack_require__(3158);
    __webpack_require__(776);
    __webpack_require__(8933);
    var client = __webpack_require__(9114);
    var adminMetaGraphql = __webpack_require__(8692);
    var dataGetter = __webpack_require__(9549);
    __webpack_require__(9200);
    __webpack_require__(4626);
    __webpack_require__(2016);
    __webpack_require__(4432);
    ...
    function useAdminMeta(adminMetaHash, fieldViews) {
      ...
      const [fetchStaticAdminMeta, { data, error, called }] =
        client.useLazyQuery(adminMetaGraphql.staticAdminMetaQuery, {
          fetchPolicy: 'network-only',
        });
      let shouldFetchAdminMeta =
      ...
      const runtimeAdminMeta = React.useMemo(() => {
        ...
        adminMeta.lists.forEach((list) => {
          runtimeAdminMeta.lists[list.key] = _objectSpread(
            _objectSpread({}, list),
            {},
            {
          ...
          list.fields.forEach((field) => {
            ...
            runtimeAdminMeta.lists[list.key].fields[field.path] = _objectSpread(
              _objectSpread({}, field),
              {},
              {
                itemView: {
                  fieldMode:
                    (_field$itemView$field =
                      (_field$itemView = field.itemView) === null ||
                      _field$itemView === void 0
                        ? void 0
                        : _field$itemView.fieldMode) !== null &&
                    _field$itemView$field !== void 0
                      ? _field$itemView$field
                      : null,
                },
                views,
    ...
    function useLazyMetadata(query) {
      ...
      return React.useMemo(() => {
        var _result$error,
          _result$error$network,
          _result$error2,
          _result$error$network2,
          _result$error3,
          _result$error$network3,
          _result$error4;
        ...
        let dataGetter$1 = dataGetter.makeDataGetter(
          result.data,
          (_result$error = result.error) === null || _result$error === void 0
            ? void 0
            : _result$error.graphQLErrors
        );
        ...
        return {
          ...
          authenticatedItem: getAuthenticatedItem(
            ...
            authenticatedItemGetter.errors ||
              ((_result$error$network =
                (_result$error2 = result.error) === null ||
                _result$error2 === void 0
                  ? void 0
                  : _result$error2.networkError) !== null &&
              _result$error$network !== void 0
                ? _result$error$network
                : undefined)
          ),
          visibleLists: getVisibleLists(
            result,
            keystoneMetaGetter.errors ||
              ((_result$error$network2 =
                (_result$error3 = result.error) === null ||
                _result$error3 === void 0
                  ? void 0
                  : _result$error3.networkError) !== null &&
              _result$error$network2 !== void 0
                ? _result$error$network2
                : undefined)
          ),
          createViewFieldModes: getCreateViewFieldModes(
            ...
            keystoneMetaGetter.errors ||
              ((_result$error$network3 =
                (_result$error4 = result.error) === null ||
                _result$error4 === void 0
                  ? void 0
                  : _result$error4.networkError) !== null &&
              _result$error$network3 !== void 0
                ? _result$error$network3
                : undefined)
          ),
        };
    ...
    function getAuthenticatedItem(_ref3, error) {
      ...
      if (data) {
        if (
          !data.authenticatedItem || // this is for the case where there is a new type
        ...
        return {
          ...
          label:
            data.authenticatedItem[labelField] || data.authenticatedItem.id,
    ...
    function InternalKeystoneProvider(_ref) {
      ...
      const reinitContext = () => {
        ...
        adminMeta === null || adminMeta === void 0
          ? void 0
          : (_adminMeta$refetch = adminMeta.refetch) === null ||
            _adminMeta$refetch === void 0
          ? void 0
          : _adminMeta$refetch.call(adminMeta);
        refetch();
      };
  ...
  /***/ 5246: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    ...
    var _objectWithoutProperties = __webpack_require__(776);
    var router = __webpack_require__(1853);
    var Link$1 = __webpack_require__(3537);
    var React = __webpack_require__(6689);
    ...
    const Link = (_ref) => {
      let { href, as, replace, scroll, shallow, prefetch } = _ref,
  ...
  /***/ 5250: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    'use strict';

    var _extends = __webpack_require__(8525);
    var _objectWithoutProperties = __webpack_require__(776);
    var core = __webpack_require__(1138);
  ...
  /***/ 5064: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    ...
    var _extends = __webpack_require__(8525);
    var core = __webpack_require__(1138);
    var adminUi_router_dist_keystone6CoreAdminUiRouter =
      __webpack_require__(5246);
    ...
    const CellLink = (props) => {
      const { colors, spacing } = core.useTheme();
      return core.jsx(
        adminUi_router_dist_keystone6CoreAdminUiRouter.Link,
        _extends(
          {
            css: {
  ...
  /***/ 9807: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    ...
    var loading = __webpack_require__(4106);
    var client = __webpack_require__(9114);
    var adminUi_context_dist_keystone6CoreAdminUiContext =
      __webpack_require__(904);
    var Fields = __webpack_require__(7992);
    var GraphQLErrorNotice = __webpack_require__(2737);
    ...
    function CreateItemDrawer(_ref) {
      let { listKey, onClose, onCreate } = _ref;
      const { createViewFieldModes } =
        adminUi_context_dist_keystone6CoreAdminUiContext.useKeystone();
      const list =
        adminUi_context_dist_keystone6CoreAdminUiContext.useList(listKey);
      const toasts = toast.useToasts();
      const [createItem, { loading: loading$1, error }] =
  ...
  /***/ 7992: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    'use strict';
    ...
    const RenderField = /*#__PURE__*/ React.memo(function RenderField(_ref) {
      let { field, value, autoFocus, forceValidation, onChange } = _ref;
    ...
    function Fields(_ref2) {
      ...
      const renderedFields = Object.keys(fields)
        .filter(
          (fieldPath) =>
            fieldModes === null || fieldModes[fieldPath] !== 'hidden'
        )
        .map((fieldPath, index) => {
          const field = fields[fieldPath];
          const val = value[fieldPath];
          const fieldMode =
            fieldModes === null ? 'edit' : fieldModes[fieldPath];
  ...
  /***/ 2737: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    'use strict';
...
`;
    ...
    const SignoutButton = (_ref) => {
      let { children } = _ref;
      const [endSession, { loading, data }] = client.useMutation(END_SESSION);
      React.useEffect(() => {
  ...
  /***/ 8692: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    'use strict';
...
`; // generated by https://graphql-code-generator.com with these options:
  ...
  /***/ 5006: /***/ (__unused_webpack_module, exports) => {
    'use strict';

    // TODO: don't duplicate this between here and packages/keystone/ListTypes/list.js
    function getGqlNames(_ref) {
      let { listKey, pluralGraphQLName } = _ref;
      const lowerPluralName =
        pluralGraphQLName.slice(0, 1).toLowerCase() +
        pluralGraphQLName.slice(1);
  ...
  /***/ 9549: /***/ (__unused_webpack_module, exports) => {
    'use strict';
    ...
    function dataGetterWithNoErrors(data, path) {
      return {
        ...
        get(field) {
          ...
          return dataGetterWithNoErrors(
            (_data$field =
              data === null || data === void 0 ? void 0 : data[field]) !==
              null && _data$field !== void 0
              ? _data$field
              : null,
            path.concat(field)
          );
        ...
        get(field) {
          ...
          let errorsForField = errors.filter((error) => {
            ...
            return newPath.every(
              (value, index) =>
                errorPath[index] === undefined || errorPath[index] === value
            );
          });
  ...
  /***/ 3809: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    ...
    const getRootGraphQLFieldsFromFieldController = weakMemoize__default[
      'default'
    ]((controller) => {
  ...
  ${controller.graphqlSelection}
    ...
    exports.getRootGraphQLFieldsFromFieldController =
  ...
  /***/ 8933: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    ...
    var graphqlTsSchema__namespace =
      /*#__PURE__*/ _interopNamespace(graphqlTsSchema);
    var GraphQLUpload__default = /*#__PURE__*/ _interopDefault(GraphQLUpload);

    const JSON = graphqlTsSchema__namespace.graphql.scalar(
      graphqlTypeJson.GraphQLJSON
    );
    const Upload = graphqlTsSchema__namespace.graphql.scalar(
      GraphQLUpload__default['default']
    ...
    const Decimal = graphqlTsSchema__namespace.graphql.scalar(
      new graphql.GraphQLScalarType({
        ...
        serialize(value) {
          if (!Decimal$1.Decimal.isDecimal(value)) {
            throw new graphql.GraphQLError(
              `unexpected value provided to Decimal scalar: ${value}`
            );
          }
        ...
        parseLiteral(value) {
          if (value.kind !== 'StringValue') {
            throw new graphql.GraphQLError(
              'Decimal only accepts values as strings'
            );
          }
    ...
    const DateTime = graphqlTsSchema__namespace.graphql.scalar(
      new graphql.GraphQLScalarType({
        name: 'DateTime',
        specifiedByUrl:
        ...
        serialize(value) {
          if (!(value instanceof Date) || isNaN(value.valueOf())) {
            throw new graphql.GraphQLError(
              `unexpected value provided to DateTime scalar: ${value}`
            );
          }
        ...
        parseLiteral(value) {
          if (value.kind !== 'StringValue') {
            throw new graphql.GraphQLError(
              'DateTime only accepts values as strings'
            );
          }
    ...
    var graphqlBoundToKeystoneContext = /*#__PURE__*/ Object.freeze({
      ...
      bindGraphQLSchemaAPIToContext:
        graphqlTsSchema.bindGraphQLSchemaAPIToContext,
  ...
  /***/ 3158: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    'use strict';

    var graphqlTsSchema = __webpack_require__(8933);
    var _objectSpread = __webpack_require__(8043);
    __webpack_require__(9200);
    __webpack_require__(4626);
    var apiWithoutContext = __webpack_require__(2016);
    ...
    const StringNullableFilter$1 = apiWithoutContext.inputObject({
      ...
      fields: () => ({
        ...
        // can be null
        in: apiWithoutContext.arg({
          type: apiWithoutContext.list(
            apiWithoutContext.nonNull(apiWithoutContext.String)
          ),
        }),
        // can be null
        notIn: apiWithoutContext.arg({
    ...
    const BoolNullableListFilter = apiWithoutContext.inputObject({
      ...
      fields: () => ({
        ...
        equals: apiWithoutContext.arg({
          type: apiWithoutContext.list(
            apiWithoutContext.nonNull(apiWithoutContext.Boolean)
          ),
        }),
        // can be null
        has: apiWithoutContext.arg({
    ...
    const IntNullableFilter$1 = apiWithoutContext.inputObject({
      ...
      fields: () => ({
        ...
        in: apiWithoutContext.arg({
          type: apiWithoutContext.list(
            apiWithoutContext.nonNull(apiWithoutContext.Int)
          ),
        }),
        // can be null
        notIn: apiWithoutContext.arg({
    ...
    const FloatNullableFilter$1 = apiWithoutContext.inputObject({
      ...
      fields: () => ({
        ...
        in: apiWithoutContext.arg({
          type: apiWithoutContext.list(
            apiWithoutContext.nonNull(apiWithoutContext.Float)
          ),
        }),
        // can be null
        notIn: apiWithoutContext.arg({
    ...
    const DateTimeNullableFilter$1 = apiWithoutContext.inputObject({
      ...
      fields: () => ({
        ...
        in: apiWithoutContext.arg({
          type: apiWithoutContext.list(
            apiWithoutContext.nonNull(graphqlTsSchema.DateTime)
          ),
        }),
        // can be null
        notIn: apiWithoutContext.arg({
    ...
    const DecimalNullableFilter$1 = apiWithoutContext.inputObject({
      ...
      fields: () => ({
        ...
        in: apiWithoutContext.arg({
          type: apiWithoutContext.list(
            apiWithoutContext.nonNull(graphqlTsSchema.Decimal)
          ),
        }),
        // can be null
        notIn: apiWithoutContext.arg({
  ...
  /***/ 4532: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    ...
    var React = __webpack_require__(6689);
    var isDeepEqual = __webpack_require__(2404);
    var getRootGraphQLFieldsFromFieldController = __webpack_require__(3809);
    ...
    function deserializeValue(fields, itemGetter) {
      ...
      Object.keys(fields).forEach((fieldKey) => {
        ...
        for (const graphqlField of getRootGraphQLFieldsFromFieldController.getRootGraphQLFieldsFromFieldController(
          field.controller
        )) {
    ...
    function useChangedFieldsAndDataForUpdate(fields, itemGetter, value) {
      ...
      return React.useMemo(() => {
        ...
        Object.keys(serializedFieldValues).forEach((fieldKey) => {
          let isEqual = isDeepEqual__default['default'](
  ...
  /***/ 3243: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    'use strict';

    var React = __webpack_require__(6689);

    function useFormattedInput(config, _ref) {
      let { value, onChange, onBlur, onFocus } = _ref;

      // typeof value === 'string' implies the unparsed form
      // typeof value !== 'string' implies the parsed form
      if (
        typeof value === 'string' &&
        typeof config.parse(value) !== 'string'
      ) {
        throw new Error(
      ...
      let [internalValueState, setInternalValueState] = React.useState(() =>
  ...
  /***/ 3879: /***/ (module, __unused_webpack_exports, __webpack_require__) => {
    'use strict';

    if (true) {
      module.exports = __webpack_require__(9238);
    } else {
    }
  ...
  /***/ 9238: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    ...
    function validate(value, validation, fieldLabel) {
      ...
      if (value.kind === 'editing') {
        ...
        if (
          ...
          dumbPasswords__default['default'].check(val)
        ) {
    ...
    const Field = (_ref) => {
      let { field, value, onChange, forceValidation, autoFocus } = _ref;
          ...
          : core.jsx(
              ...
              core.jsx(
                ...
                core.jsx(
                  ...
                  showInputValue
                    ? core.jsx(EyeOffIcon.EyeOffIcon, null)
                    : core.jsx(EyeIcon.EyeIcon, null)
                ),
                core.jsx(Spacer, null),
                core.jsx(
                  button.Button,
                  ...
                  core.jsx(core.VisuallyHidden, null, 'Cancel'),
                  core.jsx(XIcon.XIcon, null)
                )
              ),
              validation
            )
    ...
    const Cell = (_ref2) => {
      ...
      return core.jsx(
        ...
        null,
        isSetText(
          (_item$field$path = item[field.path]) === null ||
            _item$field$path === void 0
            ? void 0
            : _item$field$path.isSet
        )
      );
    };
    const CardValue = (_ref3) => {
      ...
      let { item, field } = _ref3;
      return core.jsx(
        fields.FieldContainer,
        null,
        core.jsx(fields.FieldLabel, null, field.label),
        isSetText(
          (_item$field$path2 = item[field.path]) === null ||
            _item$field$path2 === void 0
            ? void 0
            : _item$field$path2.isSet
        )
      );
    };
    const controller = (config) => {
      const validation = _objectSpread(
        _objectSpread({}, config.fieldMeta.validation),
        {},
        {
          match:
      ...
      return {
        ...
        deserialize: (data) => {
          ...
          return {
            kind: 'initial',
            isSet:
              (_data$config$path$isS =
                (_data$config$path = data[config.path]) === null ||
                _data$config$path === void 0
                  ? void 0
                  : _data$config$path.isSet) !== null &&
              _data$config$path$isS !== void 0
                ? _data$config$path$isS
                : null,
          };
        },
  ...
  /***/ 1186: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    'use strict';

    Object.defineProperty(exports, '__esModule', { value: true });

    var _objectWithoutProperties = __webpack_require__(776);
    var _toPropertyKey = __webpack_require__(786);
            ...
            if (field.search !== null) {
              conditions.push({
                [field.path]: {
                  ...
                  mode:
                    field.search === 'insensitive' ? 'insensitive' : undefined,
                },
              });
            }
          }
  ...
  `;
      ...
      const { data, error, loading, fetchMore } = client.useQuery(QUERY, {
        fetchPolicy: 'network-only',
        variables: {
          where,
      ...
      const count =
        (data === null || data === void 0 ? void 0 : data.count) || 0;
      const options =
        (data === null || data === void 0
          ? void 0
          : (_data$items = data.items) === null || _data$items === void 0
          ? void 0
          : _data$items.map((_ref3) => {
              let { [idField]: value, [labelField]: label } = _ref3,
                data = _objectWithoutProperties(
                  _ref3,
                  [idField, labelField].map(_toPropertyKey)
                );
      ...
      useIntersectionObserver(
        (_ref4) => {
          let [{ isIntersecting }] = _ref4;
          const skip =
            data === null || data === void 0 ? void 0 : data.items.length;
          ...
          if (
            ...
            ((lastFetchMore === null || lastFetchMore === void 0
              ? void 0
      ...
      if (state.kind === 'one') {
        return core.jsx(
          ...
          core.jsx(
            fields.Select, // this is necessary because react-select passes a second argument to onInputChange
      ...
      return core.jsx(
        ...
        core.jsx(
          fields.MultiSelect, // this is necessary because react-select passes a second argument to onInputChange
          // and useState setters log a warning if a second argument is passed
          {
            onInputChange: (val) => setSearch(val),
            isLoading: loading || isLoading,
    ...
    const relationshipSelectComponents = {
      MenuList: (_ref5) => {
        ...
        const { count, ref } = React.useContext(LoadingIndicatorContext);
        return core.jsx(
          fields.selectComponents.MenuList,
          props,
          children,
          core.jsx(
            'div',
  ...
  /***/ 3452: /***/ (module, __unused_webpack_exports, __webpack_require__) => {
    ...
    if (true) {
      module.exports = __webpack_require__(8340);
    } else {
    }
  ...
  /***/ 8340: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    'use strict';
    ...
    __webpack_require__(1610);
    __webpack_require__(8369);
    var CreateItemDrawer = __webpack_require__(9807);
    __webpack_require__(5584);
    ...
    var toast = __webpack_require__(2744);
    var Fields = __webpack_require__(7992);
    var useInvalidFields = __webpack_require__(4532);
    __webpack_require__(6661);
    __webpack_require__(4380);
    __webpack_require__(3158);
    __webpack_require__(8933);
    ...
    function useItemState(_ref) {
      let { selectedFields, localList, id, field } = _ref;
      const { data, error, loading } = client.useQuery(
        client.gql`query($id: ID!) {
  item: ${localList.gqlNames.itemQueryName}(where: {id: $id}) {
    ...
    relationship: ${field.path} {
      ...
      const { itemsArrFromData, relationshipGetter } = React.useMemo(() => {
        const dataGetter$1 = dataGetter.makeDataGetter(
          data,
          error === null || error === void 0 ? void 0 : error.graphQLErrors
        );
        ...
        const itemsArrFromData = (
          ...
          return (
            ((_x$data = x.data) === null || _x$data === void 0
              ? void 0
              : _x$data.id) != null
          );
        });
      ...
      if (itemsArrFromDataState !== itemsArrFromData) {
        ...
        itemsArrFromData.forEach((item) => {
          ...
          const initialItemInState =
            (_items$item$data$id = items[item.data.id]) === null ||
            _items$item$data$id === void 0
              ? void 0
              : _items$item$data$id.fromInitialQuery;

          if (
            ((items[item.data.id] && initialItemInState) ||
              !items[item.data.id]) &&
            (!initialItemInState ||
              item.data !== initialItemInState.data ||
              ((_item$errors = item.errors) === null || _item$errors === void 0
                ? void 0
                : _item$errors.length) !==
                ((_initialItemInState$e = initialItemInState.errors) === null ||
                _initialItemInState$e === void 0
                  ? void 0
                  : _initialItemInState$e.length) ||
              (item.errors || []).some((err, i) => {
                var _initialItemInState$e2;

                return (
                  err !==
                  ((_initialItemInState$e2 = initialItemInState.errors) ===
                    null || _initialItemInState$e2 === void 0
                    ? void 0
                    : _initialItemInState$e2[i])
                );
              }))
          ) {
          ...
          (items) => {
            setItemsState((state) => {
              ...
              Object.keys(items).forEach((id) => {
                ...
                if (
                  items[id] ===
                  ((_state$items$id = state.items[id]) === null ||
                  _state$items$id === void 0
                    ? void 0
                    : _state$items$id.current)
                ) {
                  ...
                  itemsForState[id] = {
                    current: items[id],
                    fromInitialQuery:
                      (_state$items$id2 = state.items[id]) === null ||
                      _state$items$id2 === void 0
                        ? void 0
                        : _state$items$id2.fromInitialQuery,
                  };
                }
              });
              return {
        ...
        state: (() => {
          ...
          if (field.many && !relationshipGetter.data) {
            ...
            return {
              kind: 'error',
              message:
                ((_relationshipGetter$e = relationshipGetter.errors) === null ||
                _relationshipGetter$e === void 0
                  ? void 0
                  : _relationshipGetter$e[0].message) || '',
            };
          }
    ...
    function InlineEdit(_ref) {
      ...
      let { fields, list, selectedFields, itemGetter, onCancel, onSave } = _ref;
      const fieldsObj = useFieldsObj(list, fields);
      const [update, { loading, error }] = client.useMutation(
        client.gql`mutation ($data: ${list.gqlNames.updateInputName}!, $id: ID!) {
      ...
      if (
        ...
        (_itemGetter$errors = itemGetter.errors) !== null &&
        _itemGetter$errors !== void 0 &&
        _itemGetter$errors.every((x) => {
          var _x$path;

          return (
            ((_x$path = x.path) === null || _x$path === void 0
              ? void 0
              : _x$path.length) !== 1
          );
        })
      ...
      const { changedFields, dataForUpdate } =
        useInvalidFields.useChangedFieldsAndDataForUpdate(
          fieldsObj,
          itemGetter,
          state.value
        );
      const invalidFields = useInvalidFields.useInvalidFields(
        fieldsObj,
        state.value
      );
      const [forceValidation, setForceValidation] = React.useState(false);
              ...
              const error =
                errors === null || errors === void 0
                  ...
                  : errors.find((x) => {
                      ...
                      return (
                        ((_x$path2 = x.path) === null || _x$path2 === void 0
                          ? void 0
                          : _x$path2.length) === 1
                      );
                    });
      ...
      return core.jsx(
        ...
        error &&
          core.jsx(GraphQLErrorNotice.GraphQLErrorNotice, {
            networkError:
              error === null || error === void 0 ? void 0 : error.networkError, // we're checking for path.length === 1 because errors with a path larger than 1 will be field level errors
            // which are handled seperately and do not indicate a failure to update the item
            errors:
              error === null || error === void 0
                ? void 0
                : error.graphQLErrors.filter((x) => {
                    var _x$path3;

                    return (
                      ((_x$path3 = x.path) === null || _x$path3 === void 0
                        ? void 0
                        : _x$path3.length) === 1
                    );
                  }),
        ...
        core.jsx(
          ...
          changedFields.size
            ? core.jsx(button.Button, saveButtonProps)
            : core.jsx(
                tooltip.Tooltip,
                {
                  content:
                    'No fields have been modified so you cannot save changes',
                },
                (props) =>
                  core.jsx(
                    button.Button,
                    _extends({}, props, saveButtonProps, {
    ...
    function InlineCreate(_ref) {
      ...
      const onCreateClick = () => {
        ...
        if (newForceValidation) return;
        const data = {};
        const allSerializedValues =
          useInvalidFields.serializeValueToObjByFieldKey(fields, value);
    ...
    function Cards(_ref2) {
      ...
      let selectedFields = [
        ...new Set([
          ...
          ...(((_displayOptions$inlin = displayOptions.inlineEdit) === null ||
          _displayOptions$inlin === void 0
            ? void 0
            : _displayOptions$inlin.fields) || []),
        ]),
      ]
        .map((fieldPath) => {
      ...
      const [hideConnectItemsLabel, setHideConnectItemsLabel] =
      ...
      return core.jsx(
        ...
        onChange === undefined
          ? null
          : displayOptions.inlineConnect && showConnectItems
          ? core.jsx(
              CardContainer,
              {
                mode: 'edit',
              ...
              core.jsx(
                ...
                core.jsx(
                  fields_types_relationship_views_RelationshipSelect_dist_keystone6CoreFieldsTypesRelationshipViewsRelationshipSelect.RelationshipSelect,
                  {
                    autoFocus: true,
                    ...
                    state: {
                      ...
                      async onChange(options) {
                        ...
                        if (itemsToFetchAndConnect.length) {
                          try {
                            const { data, errors } = await client$1.query({
                      ...
                      items: ${foreignList.gqlNames.listQueryName}(where: { id: { in: $ids }}) {
                        ${selectedFields}
                            ...
                            if (isMountedRef.current) {
                              const dataGetters = dataGetter.makeDataGetter(
                                data,
                                errors
                              );
    ...
    function LinkToRelatedItems(_ref) {
      ...
      let { itemId, value, list, refFieldKey } = _ref;

      function constructQuery(_ref2) {
        let { refFieldKey, itemId, value } = _ref2;

        if (!!refFieldKey && itemId) {
          return `!${refFieldKey}_matches="${itemId}"`;
        }

        return `!id_in="${(value === null || value === void 0
          ? void 0
          : value.value
        )
          .slice(0, 100)
      ...
      return core.jsx(
        ...
        _extends({}, commonProps, {
          as: adminUi_router_dist_keystone6CoreAdminUiRouter.Link,
          href: `/${list.path}/${
            (_value$value = value.value) === null || _value$value === void 0
              ? void 0
              : _value$value.id
          }`,
        }),
    ...
    const Field = (_ref6) => {
      ...
      let { field, autoFocus, value, onChange, forceValidation } = _ref6;
      const keystone =
        adminUi_context_dist_keystone6CoreAdminUiContext.useKeystone();
      const foreignList =
        adminUi_context_dist_keystone6CoreAdminUiContext.useList(
          field.refListKey
        );
      const localList =
        adminUi_context_dist_keystone6CoreAdminUiContext.useList(field.listKey);
      ...
      if (value.kind === 'cards-view') {
        return core.jsx(
          ...
          core.jsx(fields.FieldLegend, null, field.label),
          core.jsx(Cards, {
            forceValidation: forceValidation,
            field: field,
            id: value.id,
              ...
              core.jsx(
                ...
                core.jsx(
                  ...
                  authenticatedItem.state === 'authenticated' &&
                    ...
                    (value.kind === 'many'
                      ? value.value.find(
                          (x) => x.id === authenticatedItem.id
                        ) === undefined
                      : ((_value$value2 = value.value) === null ||
                        _value$value2 === void 0
                          ? void 0
                          : _value$value2.id) !== authenticatedItem.id) &&
                    core.jsx(
                      button.Button,
                      {
                        size: 'small',
    ...
    const Cell = (_ref7) => {
      let { field, item } = _ref7;
      const list = adminUi_context_dist_keystone6CoreAdminUiContext.useList(
        field.refListKey
      );
      const { colors } = core.useTheme();

      if (field.display === 'count') {
        var _item$;

        const count =
          (_item$ = item[`${field.path}Count`]) !== null && _item$ !== void 0
            ? _item$
            : 0;
        return core.jsx(
          CellContainer.CellContainer,
          ...
          count,
          ' ',
          count === 1 ? list.singular : list.plural
        );
      }
    ...
    const controller = (config) => {
      ...
      return {
        ...
        deserialize: (data) => {
          if (config.fieldMeta.displayMode === 'count') {
            ...
            return {
              ...
              kind: 'count',
              count:
                (_data$ = data[`${config.path}Count`]) !== null &&
                _data$ !== void 0
                  ? _data$
                  : 0,
            };
        ...
        filter: {
          Filter: (_ref9) => {
            let { onChange, value } = _ref9;
            const foreignList =
              adminUi_context_dist_keystone6CoreAdminUiContext.useList(
                config.fieldMeta.refListKey
              );
        ...
        serialize: (state) => {
          if (state.kind === 'many') {
            ...
            if (state.initialValue && !state.value) {
              ...
              state.value &&
              state.value.id !==
                ((_state$initialValue = state.initialValue) === null ||
                _state$initialValue === void 0
                  ? void 0
                  : _state$initialValue.id)
            ) {
              return {
                [config.path]: {
                  connect: {
  ...
  /***/ 9103: /***/ (module, __unused_webpack_exports, __webpack_require__) => {
    'use strict';
  ...
  /***/ 2307: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    ...
    const Field = (_ref) => {
      let { field, value, onChange, autoFocus, forceValidation } = _ref;
    ...
    const Cell = (_ref2) => {
      ...
      let { item, field, linkTo } = _ref2;
      let value = item[field.path] + '';
      const label =
        (_field$options$find = field.options.find((x) => x.value === value)) ===
          null || _field$options$find === void 0
          ? void 0
          : _field$options$find.label;
      return linkTo
        ? core.jsx(CellLink.CellLink, linkTo, label)
        : core.jsx(CellContainer.CellContainer, null, label);
    };
    Cell.supportsLinkTo = true;
    const CardValue = (_ref3) => {
      ...
      let value = item[field.path] + '';
      const label =
        (_field$options$find2 = field.options.find(
          (x) => x.value === value
        )) === null || _field$options$find2 === void 0
          ? void 0
          : _field$options$find2.label;
      return core.jsx(
        fields.FieldContainer,
        null,
        core.jsx(fields.FieldLabel, null, field.label),
    ...
    const controller = (config) => {
      ...
      const stringifiedDefault =
        (_config$fieldMeta$def = config.fieldMeta.defaultValue) === null ||
        _config$fieldMeta$def === void 0
          ? void 0
          : _config$fieldMeta$def.toString();
      return {
        path: config.path,
        label: config.label,
        graphqlSelection: config.path,
        defaultValue: {
          kind: 'create',
          value:
            (_optionsWithStringVal = optionsWithStringValues.find(
              (x) => x.value === stringifiedDefault
            )) !== null && _optionsWithStringVal !== void 0
              ? _optionsWithStringVal
              : null,
        },
  ...
  /***/ 4071: /***/ (module, __unused_webpack_exports, __webpack_require__) => {
    ...
    if (true) {
      module.exports = __webpack_require__(9788);
    } else {
    }
  ...
  /***/ 9788: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    'use strict';
    ...
    const Field = (_ref) => {
      let { field, value, onChange, autoFocus, forceValidation } = _ref;
      const { typography, fields: fields$1 } = core.useTheme();
    ...
    function validate(value, validation, fieldLabel) {
      ...
      if (
        validation.length.min !== null &&
        val.length < validation.length.min
      ) {
        if (validation.length.min === 1) {
  ...
  /***/ 1891: /***/ (module, __unused_webpack_exports, __webpack_require__) => {
    ...
    if (true) {
      module.exports = __webpack_require__(9962);
    } else {
    }
  ...
  /***/ 9962: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    'use strict';
    ...
    __webpack_require__(2404);
    __webpack_require__(5584);
    var utils = __webpack_require__(3243);
    ...
    const Field = (_ref) => {
      ...
      let { field, value, onChange, forceValidation } = _ref;
      const [touchedFirstInput, setTouchedFirstInput] = React.useState(false);
      const [touchedSecondInput, setTouchedSecondInput] = React.useState(false);
      ...
      return core.jsx(
        ...
        core.jsx(
            ...
            ? core.jsx(
                ...
                core.jsx(
                  ...
                  core.jsx(fields.DatePicker, {
                    ...
                    value:
                      (_value$value$dateValu = value.value.dateValue) !==
                        null && _value$value$dateValu !== void 0
                        ? _value$value$dateValu
                        : '',
                  }),
                  (validationMessages === null || validationMessages === void 0
                    ? void 0
          ...
          ((value.kind === 'create' &&
            ...
            ((_field$fieldMeta$defa = field.fieldMeta.defaultValue) === null ||
            _field$fieldMeta$defa === void 0
              ? void 0
              : _field$fieldMeta$defa.kind) === 'now') ||
    ...
    function validate(value, fieldMeta, label) {
      ...
      if (
        ...
        ((typeof fieldMeta.defaultValue === 'object' &&
          ((_fieldMeta$defaultVal = fieldMeta.defaultValue) === null ||
          _fieldMeta$defaultVal === void 0
            ? void 0
            : _fieldMeta$defaultVal.kind) === 'now') ||
          fieldMeta.updatedAt)
      ) {
        return undefined;
      }
    ...
    const Cell = (_ref3) => {
      let { item, field, linkTo } = _ref3;
      let value = item[field.path];
      return linkTo
        ? core.jsx(CellLink.CellLink, linkTo, formatOutput(value))
        : core.jsx(CellContainer.CellContainer, null, formatOutput(value));
    };
    Cell.supportsLinkTo = true;
    const CardValue = (_ref4) => {
      let { item, field } = _ref4;
      return core.jsx(
        fields.FieldContainer,
        null,
        core.jsx(fields.FieldLabel, null, field.label),
    ...
    const fields = {
      text(_ref) {
        ...
        return {
          ...
          Input(_ref2) {
            ...
            return core.jsx(
              fields$1.FieldContainer,
              null,
              core.jsx(fields$1.FieldLabel, null, label),
              core.jsx(fields$1.TextInput, {
                autoFocus: autoFocus,
                value: value,
                onChange: (event) => {
      ...
      url(_ref3) {
        ...
        return {
          ...
          Input(_ref4) {
            let { value, onChange, autoFocus, forceValidation } = _ref4;
            const [blurred, setBlurred] = React.useState(false);
            const showValidation =
              forceValidation || (blurred && !validate(value));
            return core.jsx(
              fields$1.FieldContainer,
              null,
              core.jsx(fields$1.FieldLabel, null, label),
      ...
      select(_ref5) {
        let { label, options, defaultValue } = _ref5;
        const optionValuesSet = new Set(options.map((x) => x.value));
        return {
          kind: 'form',

          Input(_ref6) {
            let { value, onChange, autoFocus } = _ref6;
            return core.jsx(
              fields$1.FieldContainer,
              null,
              core.jsx(fields$1.FieldLabel, null, label),
              core.jsx(fields$1.Select, {
                autoFocus: autoFocus,
      ...
      multiselect(_ref7) {
        let { label, options, defaultValue } = _ref7;
        const valuesToOption = new Map(options.map((x) => [x.value, x]));
        return {
          kind: 'form',

          Input(_ref8) {
            let { value, onChange, autoFocus } = _ref8;
            return core.jsx(
              fields$1.FieldContainer,
              null,
              core.jsx(fields$1.FieldLabel, null, label),
              core.jsx(fields$1.MultiSelect, {
                autoFocus: autoFocus,
          ...
          validate(value) {
            return (
              ...
              value.every(
                (value) =>
                  typeof value === 'string' && valuesToOption.has(value)
              )
            );
          },
        };
      ...
      checkbox(_ref9) {
        let { label, defaultValue = false } = _ref9;
        return {
          kind: 'form',

          Input(_ref10) {
            let { value, onChange, autoFocus } = _ref10;
            return core.jsx(
              fields$1.FieldContainer,
              null,
              core.jsx(
  ...
  /***/ 8898: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    'use strict';
    ...
    var toolbar = __webpack_require__(7021);
    var _objectSpread = __webpack_require__(8043);
    var api = __webpack_require__(2940);
    ...
    var mdASTUtilFromMarkdown__default = /*#__PURE__*/ _interopDefault(
      mdASTUtilFromMarkdown
    );
    var autoLinkLiteralFromMarkdownExtension__default =
      /*#__PURE__*/ _interopDefault(autoLinkLiteralFromMarkdownExtension);
    var autoLinkLiteralMarkdownSyntax__default = /*#__PURE__*/ _interopDefault(
      autoLinkLiteralMarkdownSyntax
    );
    var gfmStrikethroughFromMarkdownExtension__default =
      /*#__PURE__*/ _interopDefault(gfmStrikethroughFromMarkdownExtension);
    var gfmStrikethroughMarkdownSyntax__default = /*#__PURE__*/ _interopDefault(
      gfmStrikethroughMarkdownSyntax
    );
    ...
    function moveChildren(editor, parent, to) {
      ...
      const parentNode = slate.Path.isPath(parent)
        ? slate.Node.get(editor, parentPath)
        : parent[0];
    ...
    function useElementWithSetNodes(editor, element) {
      ...
      const setNodes = (changes) => {
        ...
        setState({
          element,
          elementWithChanges: _objectSpread(
    ...
    const ForceValidationContext =
      /*#__PURE__*/ React__default['default'].createContext(false);
    ...
    function insertNodesButReplaceIfSelectionIsAtEmptyParagraphOrHeading(
      editor,
      nodes
    ) {
      ...
      let path =
        (_pathRefForEmptyNodeA = pathRefForEmptyNodeAtCursor) === null ||
        _pathRefForEmptyNodeA === void 0
          ? void 0
          : _pathRefForEmptyNodeA.unref();
    ...
    const DocumentFieldRelationshipsProvider =
    ...
    function RelationshipButton(_ref) {
      ...
      return core.jsx(
        React.Fragment,
        null,
        Object.entries(relationships).map((_ref2) => {
    ...
    function RelationshipElement(_ref3) {
      let { attributes, children, element } = _ref3;
    ...
    function findChildPropPaths(value, props) {
      let propPaths = _findChildPropPaths(
        value,
        {
          kind: 'object',
          value: props,
    ...
    function getPropsForConditionalChange(
      ...
      if (newValue.discriminant !== oldValue.discriminant) {
        return {
          ...
          value: getInitialPropsValue(
            prop.values[newValue.discriminant],
            relationships
          ),
        };
      } else {
    ...
    function getDocumentFeaturesForChildField(editorDocumentFeatures, options) {
      var _options$formatting,
        _options$formatting3,
        _options$formatting4,
        _options$formatting5,
        _options$formatting6,
        _options$formatting7,
        _options$formatting8;
      ...
      // AND the editor document features
      const inlineMarksFromOptions =
        (_options$formatting = options.formatting) === null ||
        _options$formatting === void 0
          ? void 0
          : _options$formatting.inlineMarks;
      const inlineMarks =
      ...
      if (options.kind === 'inline') {
        ...
        return {
          ...
          softBreaks:
            ((_options$formatting2 = options.formatting) === null ||
            _options$formatting2 === void 0
              ? void 0
              : _options$formatting2.softBreaks) === 'inherit',
        };
      }
      ...
      return {
        ...
        inlineMarks,
        softBreaks:
          ((_options$formatting3 = options.formatting) === null ||
          _options$formatting3 === void 0
            ? void 0
            : _options$formatting3.softBreaks) === 'inherit',
        documentFeatures: {
          layouts: [],
          dividers:
          ...
          formatting: {
            alignment:
              ((_options$formatting4 = options.formatting) === null ||
              _options$formatting4 === void 0
                ? void 0
                : _options$formatting4.alignment) === 'inherit'
            ...
            blockTypes:
              ((_options$formatting5 = options.formatting) === null ||
              _options$formatting5 === void 0
                ? void 0
                : _options$formatting5.blockTypes) === 'inherit'
            ...
            headingLevels:
              ((_options$formatting6 = options.formatting) === null ||
              _options$formatting6 === void 0
                ? void 0
                : _options$formatting6.headingLevels) === 'inherit'
                ? editorDocumentFeatures.formatting.headingLevels
                : ((_options$formatting7 = options.formatting) === null ||
                  _options$formatting7 === void 0
                    ? void 0
                    : _options$formatting7.headingLevels) || [],
            listTypes:
              ((_options$formatting8 = options.formatting) === null ||
              _options$formatting8 === void 0
                ? void 0
                : _options$formatting8.listTypes) === 'inherit'
    ...
    function RelationshipFormInput(_ref) {
      let { prop, path, value, onChange, stringifiedPropPathToAutoFocus } =
        _ref;
      ...
      if (prop.kind === 'conditional') {
        return /*#__PURE__*/ React__default['default'].createElement(
          ...
          /*#__PURE__*/ React__default['default'].createElement(
            ...
            {
              autoFocus:
                JSON.stringify(path.concat('discriminant')) ===
                stringifiedPropPathToAutoFocus,
              ...
              forceValidation:
                forceValidation && !prop.discriminant.validate(value),
            }
          ),
          /*#__PURE__*/ React__default['default'].createElement(
            FormValueContent,
    ...
    function findFirstFocusablePropPath(props, path, value) {
      for (const key of Object.keys(props)) {
        ...
        const childFocusable = findFirstFocusablePropPath(
          children,
          newPath,
          value[key]
        );
    ...
    function FormValue(_ref4) {
      let { value, onClose, onChange, componentBlock, isValid } = _ref4;
      const [forceValidation, setForceValidation] = React.useState(false);
      const focusablePath = JSON.stringify(
        findFirstFocusablePropPath(componentBlock.props, [], value)
      );
      return /*#__PURE__*/ React__default['default'].createElement(
        core.Stack,
        {
    ...
    function normalizeTextBasedOnInlineMarksAndSoftBreaks(
      _ref,
      editor,
      inlineMarks,
      softBreaks
        ...
        if (hasSoftBreaks) {
          ...
          if (parentNode.type !== 'code') {
            for (const position of slate.Editor.positions(editor, {
              ...
              const character = slate.Node.get(editor, position.path).text[
                position.offset
              ];
    ...
    function normalizeInlineBasedOnLinksAndRelationships(
      _ref2,
      editor,
      links,
      ...
      if (
        ...
        if (data) {
          ...
          slate.Transforms.insertText(
            editor,
            `${data.label || data.id || ''} (${
              (relationship === null || relationship === void 0
                ? void 0
    ...
    function normalizeElementBasedOnDocumentFeatures(
      _ref3,
      editor,
      _ref4,
      relationships
    ...
    function withDocumentFeaturesNormalization(
      documentFeatures,
      relationships,
      editor
    ) {
      ...
      const documentFeaturesForNormalization = _objectSpread(
        _objectSpread({}, documentFeatures),
        {},
        {
          relationships: true,
        }
    ...
    function getAncestorComponentBlock(editor) {
      if (editor.selection) {
        const ancestorEntry = slate.Editor.above(editor, {
          match: (node) =>
            slate.Editor.isBlock(editor, node) && node.type !== 'paragraph',
        });
    ...
    function withComponentBlocks(
      ...
      const memoizedGetDocumentFeaturesForChildField = weakMemoize__default[
        'default'
      ]((options) => {
      ...
      editor.insertBreak = () => {
        ...
        if (editor.selection && ancestorComponentBlock.isInside) {
          ...
          if (componentPropNode.type === 'component-block-prop') {
            const [[paragraphNode, paragraphPath]] = slate.Editor.nodes(
              editor,
              {
          ...
          if (
            ...
            if (componentBlock) {
              let missingKeys = new Map(
                findChildPropPaths(node.props, componentBlock.props).map(
                  (x) => [JSON.stringify(x.path), x.options.kind]
                )
              );
              ...
              findChildPropPaths(
                node.props,
                blockComponents[node.component].props
              ).forEach((x, index) => {
              ...
              for (const [index, childNode] of node.children.entries()) {
                if (
                  ...
                  const stringifiedPropPath = JSON.stringify(
                    childNode.propPath
                  );

                  if (
                    stringifiedInlinePropPaths[stringifiedPropPath] ===
                    undefined
                  ) {
                    slate.Transforms.removeNodes(editor, {
                      at: childPath,
                    ...
                    const documentFeatures =
                      memoizedGetDocumentFeaturesForChildField(
                        propInfo.options
                      );
    ...
    function getPlaceholderTextForPropPath(propPath, fields, formProps) {
      ...
      if (field.kind === 'relationship' || field.kind === 'form') {
        throw new Error(
          'unexpected prop field when finding placeholder text for child prop'
        );
      }
    ...
    function insertComponentBlock(
      editor,
      componentBlocks,
      componentBlock,
      relationships
    ) {
      let node = getInitialValue(
        componentBlock,
    ...
    const ComponentBlocksElement = (_ref2) => {
      let { attributes, children, element: __elementToGetPath } = _ref2;
      const editor = slateReact.useSlateStatic();
      ...
      const { colors, fields, spacing, typography } = core.useTheme();
      const blockComponents = React.useContext(ComponentBlockContext);
...
Content:`
    ...
    function DefaultToolbarWithChrome(_ref3) {
      let { onShowEditMode, onRemove, isValid } = _ref3;
      ...
      return core.jsx(
        ...
        core.jsx(toolbar.ToolbarSeparator, null),
        core.jsx(
          tooltip.Tooltip,
          {
            content: 'Remove',
    ...
    function ComponentBlockRender(_ref5) {
      let { componentBlock, element, onElementChange, children } = _ref5;
      const childrenByPath = {};
      let maybeChild;
      children.forEach((child) => {
        let stringified = JSON.stringify(
          child.props.children.props.element.propPath
        );
      ...
      return core.jsx(
        React.Fragment,
        null,
        core.jsx(componentBlock.component, previewProps),
        core.jsx(
          'span',
          {
            css: {
    ...
    const LayoutContainer = (_ref) => {
      let { attributes, children, element } = _ref;
      const { spacing } = core.useTheme();
      const focused = slateReact.useFocused();
      const selected = slateReact.useSelected();
      const editor = slateReact.useSlateStatic();
    ...
    const LayoutArea = (_ref2) => {
      let { attributes, children } = _ref2;
      const { colors, radii, spacing } = core.useTheme();
      return core.jsx(
        'div',
        _extends(
          {
    ...
    function withLayouts(editor) {
      ...
      editor.deleteBackward = (unit) => {
        if (
          editor.selection &&
          slate.Range.isCollapsed(editor.selection) && // this is just an little optimisation
          ...
          if (
            ...
            slate.Point.equals(
              slate.Editor.start(editor, abovePath),
              editor.selection.anchor
            )
          ) {
            return;
            ...
            Array.from({
              ...
              .forEach((i) => {
                ...
                moveChildren(
                  ...
                  (node) =>
                    node.type !== 'paragraph' || slate.Node.string(child) !== ''
                );
                slate.Transforms.removeNodes(editor, {
      ...
      slate.Editor.withoutNormalizing(editor, () => {
        ...
        if (!isActive) {
          slate.Transforms.wrapNodes(
            ...
            {
              match: (x) =>
                x.type !== 'list-item-content' &&
                slate.Editor.isBlock(editor, x),
            }
          );
        }
      });
    ...
    function withList(editor) {
      ...
      editor.normalizeNode = (entry) => {
        ...
        if (slate.Element.isElement(node) || slate.Editor.isEditor(node)) {
          ...
          for (const [childNode, childPath] of slate.Node.children(
            editor,
            path
          )) {
            ...
            if (isListNode(childNode)) {
              ...
              if (
                ((_node$children =
                  node.children[childPath[childPath.length - 1] + 1]) ===
                  null || _node$children === void 0
                  ? void 0
                  : _node$children.type) === childNode.type
              ) {
            ...
            if (
              ...
              index === 0 &&
              slate.Editor.isBlock(editor, childNode)
            ) {
              if (path[path.length - 1] !== 0) {
                const previousChild = slate.Node.get(
                  editor,
                  slate.Path.previous(path)
                );
    ...
    const ListButton = /*#__PURE__*/ React.forwardRef(function ListButton(
      props,
      ref
    ) {
      const {
    ...
    function nestList(editor) {
      ...
      const type = slate.Editor.parent(editor, slate.Path.parent(block[1]))[0]
        .type;
      slate.Editor.withoutNormalizing(editor, () => {
        slate.Transforms.wrapNodes(
          editor,
    ...
    const ToolbarStateContext =
      /*#__PURE__*/ React__default['default'].createContext(null);
    ...
    function getAncestorComponentChildFieldDocumentFeatures(
      ...
      if (ancestorComponentProp) {
        ...
        const ancestorComponent = slate.Editor.parent(
          editor,
          ancestorComponentProp[1]
        );
        ...
        if (ancestorComponent[0].type === 'component-block') {
          ...
          if (componentBlock && propPath) {
            ...
            const options =
              (_getChildFieldAtPropP = getChildFieldAtPropPath(
                propPath,
                ancestorComponent[0].props,
                componentBlock.props
              )) === null || _getChildFieldAtPropP === void 0
                ? void 0
                : _getChildFieldAtPropP.options;
    ...
    const createToolbarState = (
      ...
      let [maybeCodeBlockEntry] = slate.Editor.nodes(editor, {
        match: (node) =>
          node.type !== 'code' && slate.Editor.isBlock(editor, node),
      });
      ...
      return {
        ...
        textStyles: {
          ...
          allowedHeadingLevels:
            locationDocumentFeatures.kind === 'block' && !listEntry
              ? locationDocumentFeatures.documentFeatures.formatting
                  .headingLevels
              : [],
        },
        relationships: {
        ...
        alignment: {
          ...
          selected:
            (alignableEntry === null || alignableEntry === void 0
              ? void 0
              : alignableEntry[0].textAlign) || 'start',
        },
        blockquote: {
          isDisabled: !(
            locationDocumentFeatures.kind === 'block' &&
    ...
    const ToolbarStateProvider = (_ref) => {
      let { children, componentBlocks, editorDocumentFeatures, relationships } =
        _ref;
    ...
    const LinkElement = (_ref) => {
      let { attributes, children, element: __elementForGettingPath } = _ref;
      ...
      const selected = slateReact.useSelected();
      const focused = slateReact.useFocused();
      const [focusedInInlineDialog, setFocusedInInlineDialog] =
        React.useState(false); // we want to show the link dialog when the editor is focused and the link element is selected
      ...
      const [localForceValidation, setLocalForceValidation] =
        React.useState(false);
      const { dialog, trigger } = popover.useControlledPopover(
        {
      ...
      const showInvalidState = api.isValidURL(href)
        ? false
    ...
    const LinkButton = /*#__PURE__*/ React.forwardRef(function LinkButton(
      props,
      ref
    ) {
      const {
    ...
    function withLink(editorDocumentFeatures, componentBlocks, editor) {
      ...
      if (editorDocumentFeatures.links) {
        editor.insertText = (text) => {
          ...
          const startOfBlock = slate.Editor.start(
            editor,
            slate.Editor.above(editor, {
              match: (node) => slate.Editor.isBlock(editor, node),
            })[1]
          );
          const startOfBlockToEndOfShortcutString = slate.Editor.string(
            editor,
            {
          ...
          const match = markdownLinkPattern.exec(
            startOfBlockToEndOfShortcutString
          );
          if (!match) return;
          ...
          if (
            (ancestorComponentChildFieldDocumentFeatures === null ||
            ancestorComponentChildFieldDocumentFeatures === void 0
              ? void 0
              : ancestorComponentChildFieldDocumentFeatures.documentFeatures
                  .links) === false
          ) {
            return;
          }
    ...
    function getDirectBlockquoteParentFromSelection(editor) {
      ...
      const [maybeBlockquoteParent, maybeBlockquoteParentPath] =
        slate.Editor.parent(editor, parentPath);
    ...
    function withBlockquote(editor) {
      ...
      editor.deleteBackward = (unit) => {
        if (editor.selection) {
          const parentBlockquote =
            getDirectBlockquoteParentFromSelection(editor);

          if (
            parentBlockquote.isInside &&
            slate.Range.isCollapsed(editor.selection) && // the selection is at the start of the paragraph
      ...
      editor.insertBreak = () => {
        ...
        if (editor.selection && panel.isInside) {
          ...
          if (
            slate.Path.isDescendant(nodePath, panel.path) &&
      ...
      return React.useMemo(
        () =>
          core.jsx(
            ...
            core.jsx(QuoteIcon, null)
          ),
        [editor, attrs, isDisabled, isSelected]
      );
    };

    const blockquoteButton = core.jsx(
      tooltip.Tooltip,
      {
        content: core.jsx(
          React.Fragment,
          null,
          'Quote',
          core.jsx(toolbar.KeyboardInTooltip, null, '> ')
        ),
        weight: 'subtle',
      },
      (attrs) =>
        core.jsx(BlockquoteButton, {
          attrs: attrs,
        })
    );
    ...
    const minusIcon = /*#__PURE__*/ React__default['default'].createElement(
      MinusIcon.MinusIcon,
      {
        size: 'small',
      }
    ...
    const dividerButton = /*#__PURE__*/ React__default['default'].createElement(
      tooltip.Tooltip,
      {
      ...
      (attrs) =>
        /*#__PURE__*/ React__default['default'].createElement(DividerButton, {
          attrs: attrs,
        })
    );
    ...
    function Toolbar(_ref) {
      let { documentFeatures, viewState } = _ref;
      ...
      const hasBlockItems =
        Object.entries(relationship).length ||
        Object.keys(blockComponent).length;
      return core.jsx(
        ToolbarContainer,
        null,
          ...
          core.jsx(
            tooltip.Tooltip,
            {
              content: core.jsx(
                ...
                null,
                'Numbered List ',
                core.jsx(toolbar.KeyboardInTooltip, null, '1. ')
              ),
              weight: 'subtle',
            },
            (attrs) =>
              core.jsx(
                ...
                core.jsx(NumberedListIcon, null)
              )
          ),
        (documentFeatures.formatting.alignment.center ||
          documentFeatures.formatting.alignment.end ||
        ...
        !!documentFeatures.layouts.length &&
          core.jsx(LayoutsButton, {
            layouts: documentFeatures.layouts,
          }),
        documentFeatures.formatting.blockTypes.code && codeButton,
        !!hasBlockItems && core.jsx(InsertBlockMenu, null),
        core.jsx(toolbar.ToolbarSeparator, null),
        React.useMemo(() => {
          const ExpandIcon =
            viewState !== null && viewState !== void 0 && viewState.expanded
    ...
    const MarkButton = /*#__PURE__*/ React.forwardRef(function MarkButton(
      props,
      ref
    ) {
      const {
    ...
    function HeadingButton(_ref3) {
      let { trigger, onToggleShowMenu, showMenu } = _ref3;
    ...
    function HeadingDialog(_ref5) {
      let { headingLevels, onCloseMenu } = _ref5;
          ...
          core.jsx(
            tooltip.Tooltip,
            {
              content: core.jsx(
                ...
                null,
                'Bold',
                core.jsx(toolbar.KeyboardInTooltip, null, modifierKeyText, 'B')
              ),
              weight: 'subtle',
            },
            (attrs) =>
          ...
          core.jsx(
            tooltip.Tooltip,
            {
              content: core.jsx(
                ...
                null,
                'Italic',
                core.jsx(toolbar.KeyboardInTooltip, null, modifierKeyText, 'I')
              ),
              weight: 'subtle',
            },
            (attrs) =>
              core.jsx(
                ...
                core.jsx(ItalicIcon.ItalicIcon, {
                  size: 'small',
                })
              )
          ),
    ...
    function MoreFormattingDialog(_ref8) {
      let { dialog, marks, onCloseMenu } = _ref8;
    ...
    function MoreFormattingButton(_ref10) {
      let { onToggle, isOpen, trigger, attrs } = _ref10;
    ...
    function withHeading(editor) {
      ...
      editor.insertBreak = () => {
        ...
        if (
          ...
          slate.Text.isText(previousNode.children[0]) &&
    ...
    const CodeElement = (_ref) => {
      let { attributes, children } = _ref;
      const { colors, radii, spacing, typography } = core.useTheme();
      return core.jsx(
        'pre',
        _extends(
          {
          ...
          for (const [mark, shortcuts] of Object.entries(
            ...
            for (const shortcutText of shortcuts) {
              if (text === shortcutText[shortcutText.length - 1]) {
                ...
                let startOfBlockToEndOfShortcutString = slate.Editor.string(
                  editor,
                  {
                    anchor: editor.selection.anchor,
                    focus: startOfBlock,
                ...
                const hasWhitespaceBeforeEndOfShortcut = /\s/.test(
                  startOfBlockToEndOfShortcutString.substr(
                ...
                for (const [offsetFromStartOfBlock] of [...strToMatchOn]
                  ...
                  const endOfStartOfShortcut = slate.Editor.after(
                    editor,
                  ...
                  if (
                    offsetFromStartOfBlock !== 0 &&
                    !/\s/.test(
                      slate.Editor.string(editor, {
                        anchor: slate.Editor.before(
                          editor,
                          startOfStartOfShortcut,
                          {
                            unit: 'character',
    ...
    function getOptions(toolbarState, componentBlocks, relationships) {
      const options = [
        ...Object.entries(relationships)
          .filter((x) => x[1].kind === 'inline')
          .map((_ref) => {
            let [relationship, { label }] = _ref;
            return {
              label,
              insert: (editor) => {
                slate.Transforms.insertNodes(editor, {
        ...
        !toolbarState.blockquote.isDisabled &&
          toolbarState.editorDocumentFeatures.formatting.blockTypes
            .blockquote && {
            label: 'Blockquote',
        ...
        !!toolbarState.editorDocumentFeatures.layouts.length && {
          ...
          insert(editor) {
            insertLayout(
              editor,
              toolbarState.editorDocumentFeatures.layouts[0]
            );
          },
        },
        ...
        !toolbarState.lists.unordered.isDisabled &&
          toolbarState.editorDocumentFeatures.formatting.listTypes
            .unordered && {
            label: 'Bullet List',
    ...
    function InsertMenu(_ref2) {
      ...
      const relationships = useDocumentFieldRelationships();
      const options = matchSorter.matchSorter(
        getOptions(
          toolbarState,
          componentBlocks,
      ...
      React.useEffect(() => {
        ...
        const element =
          ...
          _dialogRef$current === void 0
            ? void 0
            : (_dialogRef$current$ch = _dialogRef$current.children) === null ||
              _dialogRef$current$ch === void 0
            ? void 0
            : _dialogRef$current$ch[selectedIndex];
      ...
      React.useEffect(() => {
        ...
        let listener = (event) => {
          ...
          switch (event.key) {
            ...
            case 'Enter': {
              const option =
                stateRef.current.options[stateRef.current.selectedIndex];
    ...
    function removeInsertMenuMarkWhenOutsideOfSelection(editor) {
      ...
      if (
        path &&
        !(
          (_Editor$marks = slate.Editor.marks(editor)) !== null &&
          _Editor$marks !== void 0 &&
          _Editor$marks.insertMenu
        ) &&
        (!editor.selection ||
          !slate.Path.equals(editor.selection.anchor.path, path) ||
          !slate.Path.equals(editor.selection.focus.path, path))
      ) {
        slate.Transforms.unsetNodes(editor, 'insertMenu', {
          at: path,
        });
    ...
    function withInsertMenu(editor) {
      ...
      editor.insertText = (text) => {
        ...
        if (editor.selection && text === '/') {
          ...
          if (
            before &&
            (slate.Point.equals(startOfBlock, before) ||
              (before.offset !== 0 &&
                /\s/.test(
                  slate.Node.get(editor, before.path).text[before.offset - 1]
                )))
          ) {
            slate.Transforms.setNodes(
              editor,
    ...
    const Leaf = (_ref2) => {
      let { leaf, text, children, attributes } = _ref2;
      const { colors, radii, spacing, typography } = core.useTheme();
      const {
        underline,
        strikethrough,
    ...
    function withSoftBreaks(isShiftPressedRef, editor) {
      const { insertBreak } = editor; // TODO: should soft breaks only work in particular places
        ...
        if (
          ...
          if (ancestorBlock) {
            Object.keys(shortcuts).forEach((shortcut) => {
              ...
              if (
                pointBefore &&
                slate.Path.isDescendant(pointBefore.path, ancestorBlock[1])
              ) {
                const range = {
    ...
    function withBlockMarkdownShortcuts(
      documentFeatures,
      componentBlocks,
      editor
    ) {
      ...
      const editorDocumentFeaturesForNormalizationToCheck = _objectSpread(
        _objectSpread({}, documentFeatures),
        {},
        {
          relationships: true,
    ...
    function getAlignmentFromElement(element) {
      ...
      const attribute =
        parent === null || parent === void 0
          ? void 0
          : parent.getAttribute('data-align'); // note: we don't show html that confluence would parse as alignment
    ...
    const ELEMENT_TAGS = {
      A: (el) => ({
        ...
        children: forceDisableMarkForChildren('underline', () =>
          deserializeChildren$1(el.childNodes)
        ),
      }),
      BLOCKQUOTE: () => ({
        type: 'blockquote',
        ...
        children: [
          {
            text: `<img alt=${JSON.stringify(
              el.getAttribute('alt') || ''
            )} src=${JSON.stringify(el.getAttribute('src') || '')}>`,
          },
        ],
      }),
      LI: () => ({
    ...
    function deserializeHTMLNode(el) {
      ...
      if (
        ...
        el.classList.contains('listtype-quote')
      ) {
        marks.delete('italic');
        nodeName = 'BLOCKQUOTE';
      }
    ...
    const markdownConfig = {
      mdastExtensions: [
        autoLinkLiteralFromMarkdownExtension__default['default'],
        gfmStrikethroughFromMarkdownExtension__default['default'],
      ],
      extensions: [
        autoLinkLiteralMarkdownSyntax__default['default'],
        gfmStrikethroughMarkdownSyntax__default['default'](),
      ],
    };
    function deserializeMarkdown(markdown) {
      const root = mdASTUtilFromMarkdown__default['default'](
        markdown,
        markdownConfig
      );
      ...
      switch (node.type) {
          ...
          return [
            {
              type: 'link',
              href:
                ((_getDefinition = getDefinition(node.identifier)) === null ||
                _getDefinition === void 0
                  ? void 0
                  : _getDefinition.url) || '',
              children: deserializeChildren(node.children, getDefinition),
            },
        ...
        case 'imageReference': {
          ...
          return [
            getTextNodeForCurrentlyActiveMarks(
              `![${node.alt || ''}](${
                ((_getDefinition2 = getDefinition(node.identifier)) === null ||
                _getDefinition2 === void 0
                  ? void 0
                  : _getDefinition2.url) || ''
              })`
            ),
        ...
        case 'inlineCode': {
          return addMarkToChildren('code', () => [
            getTextNodeForCurrentlyActiveMarks(node.value),
          ]);
        }
    ...
    function withPasting(editor) {
      ...
      editor.insertData = (data) => {
        ...
        if (
          (blockAbove === null || blockAbove === void 0
            ? void 0
            : blockAbove[0].type) === 'code'
        ) {
      ...
      if (event.key === 'Tab' && editor.selection) {
        ...
        if (layoutArea) {
          const layoutAreaToEnter = event.shiftKey
            ? slate.Editor.before(editor, layoutArea[1], {
                unit: 'block',
              })
    ...
    function DocumentEditor(_ref) {
      ...
      return core.jsx(
        ...
        core.jsx(
          DocumentEditorProvider,
          {
            ...
            onChange: (value) => {
              ...
              if (selection && !slateReact.ReactEditor.isFocused(editor)) {
                const editorNode = slateReact.ReactEditor.toDOMNode(
                  editor,
                  editor
                );
          ...
          core.jsx(DocumentEditorEditable, {
            css: expanded && {
    ...
    function DocumentEditorProvider(_ref2) {
      ...
      return core.jsx(
        slateReact.Slate, // this fixes issues with Slate crashing when a fast refresh occcurs
        {
          key: identity,
          editor: editor,
          value: value,
            ...
            decorate: React.useCallback(
              (_ref3) => {
                ...
                if (node.type === 'component-block') {
                  if (
                    node.children.length === 1 &&
                    slate.Element.isElement(node.children[0]) &&
                  ...
                  node.children.forEach((child, index) => {
                    if (
                      slate.Node.string(child) === '' &&
                      slate.Element.isElement(child) &&
        ...
        if (
          ...
          for (const [index, childNode] of node.children.entries()) {
            ...
            if (info.kind === 'inlines') {
              if (
                !slate.Text.isText(childNode) &&
                !slate.Editor.isInline(editor, childNode)
              ) {
                handleNodeInInvalidPosition(
                  editor,
                  [childNode, childPath],
                  path
                );
              ...
              if (
                !slate.Editor.isBlock(editor, childNode) || // these checks are implicit in Editor.isBlock
    ...
    function handleNodeInInvalidPosition(editor, _ref5, parentPath) {
      ...
      if (
        !childNodeInfo ||
        childNodeInfo.invalidPositionHandleMode === 'unwrap'
      ) {
        slate.Transforms.unwrapNodes(editor, {
          at: path,
        });
      ...
      if (
        (info === null || info === void 0 ? void 0 : info.kind) === 'blocks' &&
        info.allowedChildren.has(nodeType)
      ) {
  ...
  /***/ 7021: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    ...
    const InlineDialog = /*#__PURE__*/ React.forwardRef((_ref, ref) => {
      ...
      const { radii, spacing } = core.useTheme();
    ...
    const ToolbarGroup = core.forwardRefWithAs((_ref, ref) => {
      let { children, direction = 'row' } = _ref,
        props = _objectWithoutProperties(_ref, _excluded);
    ...
    const ToolbarButton = core.forwardRefWithAs(function ToolbarButton(
      ...
      const { colors, palette, radii, sizing, spacing, typography } =
        core.useTheme();
  ...
  /***/ 6219: /***/ (module, __unused_webpack_exports, __webpack_require__) => {
    ...
    if (true) {
      module.exports = __webpack_require__(3064);
    } else {
    }
  ...
  /***/ 3064: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    ...
    var index = __webpack_require__(8898);
    var api = __webpack_require__(2940);
    __webpack_require__(8525);
    __webpack_require__(6689);
    ...
    const Cell = (_ref2) => {
      ...
      const value =
        ...
        _item$field$path === void 0
          ? void 0
          : _item$field$path.document;
      if (!value) return null;
      const plainText = serialize(value);
      const cutText =
        plainText.length > 100 ? plainText.slice(0, 100) + '...' : plainText;
      return linkTo
        ? core.jsx(components.CellLink, linkTo, cutText)
        : core.jsx(components.CellContainer, null, cutText);
    };
    Cell.supportsLinkTo = true;
    const CardValue = (_ref3) => {
      var _item$field$path2;
      ...
      return core.jsx(
        ...
        null,
        core.jsx(fields.FieldLabel, null, field.label),
        core.jsx(documentRenderer.DocumentRenderer, {
          document:
            ((_item$field$path2 = item[field.path]) === null ||
            _item$field$path2 === void 0
              ? void 0
              : _item$field$path2.document) || [],
        })
      );
    };
    const allowedExportsOnCustomViews = ['componentBlocks'];
    const controller = (config) => {
      const memoizedIsComponentBlockValid = weakMemoize__default['default'](
        (componentBlock) =>
          weakMemoize__default['default']((props) =>
            index.clientSideValidateProp(
              {
                kind: 'object',
                value: componentBlock.props,
              },
      ...
      const clientSideComponentBlocksSet = new Set(
        Object.keys(componentBlocks)
      );
      ...
      const validateNode = weakMemoize__default['default']((node) => {
        ...
        if (
          node.type === 'link' &&
          (typeof node.href !== 'string' || !api.isValidURL(node.href))
        ) {
          return false;
        }
  ...
  /***/ 1327: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    ...
    var _router = __webpack_require__(6599);
    var _router1 = __webpack_require__(9474);
    var _useIntersection = __webpack_require__(6771);
  ...
  /***/ 8943: /***/ (__unused_webpack_module, exports) => {
    'use strict';
  ...
  /***/ 4537: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    'use strict';
    ...
    var _requestIdleCallback = __webpack_require__(8949);
    function _interopRequireDefault(obj) {
      return obj && obj.__esModule
        ? obj
        : {
  ...
  /***/ 9474: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    ...
    exports['default'] = void 0;
    var _react = _interopRequireDefault(__webpack_require__(6689));
    var _router = _interopRequireDefault(__webpack_require__(6599));
    var _routerContext = __webpack_require__(4964);
    var _isError = _interopRequireDefault(__webpack_require__(6853));
    var _withRouter = _interopRequireDefault(__webpack_require__(7867));
    function _interopRequireDefault(obj) {
      return obj && obj.__esModule
        ? obj
        : {
  ...
  /***/ 6771: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    'use strict';
  ...
  /***/ 7867: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    'use strict';
    ...
    var _react = _interopRequireDefault(__webpack_require__(6689));
    var _router = __webpack_require__(9474);
    function _interopRequireDefault(obj) {
      return obj && obj.__esModule
        ? obj
        : {
  ...
  /***/ 6599: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    'use strict';
    ...
    exports['default'] = void 0;
    var _normalizeTrailingSlash = __webpack_require__(8943);
    var _routeLoader = __webpack_require__(4537);
      ...
      async _preflightRequest(options) {
        ...
        const requiresPreflight = fns.some(([middleware, isSSR]) => {
          return (0, _routeMatcher).getRouteMatcher(
            (0, _getMiddlewareRegex).getMiddlewareRegex(middleware, !isSSR)
          )(cleanedAs);
        });
        ...
        if (preflight.rewrite) {
          ...
          const fsPathname = (0,
          _normalizeTrailingSlash).removePathTrailingSlash(parsed.pathname);
          let matchedPage;
          let resolvedHref;
  ...
  /***/ 3537: /***/ (module, __unused_webpack_exports, __webpack_require__) => {
